...
// checks if the ListTeamsInOrganizationById200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTeamsInOrganizationById200Response{}
...
func NewListTeamsInOrganizationById200Response(items []OrganizationTeam) *ListTeamsInOrganizationById200Response {
	this := ListTeamsInOrganizationById200Response{}
	this.Items = items
	return &this
}
...
type NullableListTeamsInOrganizationById200Response struct {
	value *ListTeamsInOrganizationById200Response
	isSet bool
}

func (v NullableListTeamsInOrganizationById200Response) Get() *ListTeamsInOrganizationById200Response {
	return v.value
}

func (v *NullableListTeamsInOrganizationById200Response) Set(val *ListTeamsInOrganizationById200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListTeamsInOrganizationById200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListTeamsInOrganizationById200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTeamsInOrganizationById200Response(val *ListTeamsInOrganizationById200Response) *NullableListTeamsInOrganizationById200Response {
	return &NullableListTeamsInOrganizationById200Response{value: val, isSet: true}
}

func (v NullableListTeamsInOrganizationById200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTeamsInOrganizationById200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
