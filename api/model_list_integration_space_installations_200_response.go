...
// checks if the ListIntegrationSpaceInstallations200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListIntegrationSpaceInstallations200Response{}
...
func NewListIntegrationSpaceInstallations200Response(items []IntegrationSpaceInstallation) *ListIntegrationSpaceInstallations200Response {
	this := ListIntegrationSpaceInstallations200Response{}
	this.Items = items
	return &this
}
...
func (o ListIntegrationSpaceInstallations200Response) MarshalJSON() ([]byte, error) {
...
type NullableListIntegrationSpaceInstallations200Response struct {
	value *ListIntegrationSpaceInstallations200Response
	isSet bool
}

func (v NullableListIntegrationSpaceInstallations200Response) Get() *ListIntegrationSpaceInstallations200Response {
	return v.value
}

func (v *NullableListIntegrationSpaceInstallations200Response) Set(val *ListIntegrationSpaceInstallations200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListIntegrationSpaceInstallations200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListIntegrationSpaceInstallations200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListIntegrationSpaceInstallations200Response(val *ListIntegrationSpaceInstallations200Response) *NullableListIntegrationSpaceInstallations200Response {
	return &NullableListIntegrationSpaceInstallations200Response{value: val, isSet: true}
}

func (v NullableListIntegrationSpaceInstallations200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListIntegrationSpaceInstallations200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
