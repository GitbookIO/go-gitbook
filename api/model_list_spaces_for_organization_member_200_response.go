...
// checks if the ListSpacesForOrganizationMember200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSpacesForOrganizationMember200Response{}
...
func NewListSpacesForOrganizationMember200Response(items []MemberContentPermission) *ListSpacesForOrganizationMember200Response {
	this := ListSpacesForOrganizationMember200Response{}
	this.Items = items
	return &this
}
...
func (o ListSpacesForOrganizationMember200Response) MarshalJSON() ([]byte, error) {
...
type NullableListSpacesForOrganizationMember200Response struct {
	value *ListSpacesForOrganizationMember200Response
	isSet bool
}

func (v NullableListSpacesForOrganizationMember200Response) Get() *ListSpacesForOrganizationMember200Response {
	return v.value
}

func (v *NullableListSpacesForOrganizationMember200Response) Set(val *ListSpacesForOrganizationMember200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSpacesForOrganizationMember200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSpacesForOrganizationMember200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSpacesForOrganizationMember200Response(val *ListSpacesForOrganizationMember200Response) *NullableListSpacesForOrganizationMember200Response {
	return &NullableListSpacesForOrganizationMember200Response{value: val, isSet: true}
}

func (v NullableListSpacesForOrganizationMember200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSpacesForOrganizationMember200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
