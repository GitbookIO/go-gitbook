...
// checks if the RecordingSpeechEventAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RecordingSpeechEventAllOf{}
...
func NewRecordingSpeechEventAllOf(type_ string) *RecordingSpeechEventAllOf {
	this := RecordingSpeechEventAllOf{}
	this.Type = type_
	return &this
}
...
type NullableRecordingSpeechEventAllOf struct {
	value *RecordingSpeechEventAllOf
	isSet bool
}

func (v NullableRecordingSpeechEventAllOf) Get() *RecordingSpeechEventAllOf {
	return v.value
}

func (v *NullableRecordingSpeechEventAllOf) Set(val *RecordingSpeechEventAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRecordingSpeechEventAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRecordingSpeechEventAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRecordingSpeechEventAllOf(val *RecordingSpeechEventAllOf) *NullableRecordingSpeechEventAllOf {
	return &NullableRecordingSpeechEventAllOf{value: val, isSet: true}
}
