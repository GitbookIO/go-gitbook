...
// checks if the ListSpacesForAuthenticatedUser200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSpacesForAuthenticatedUser200Response{}
...
func NewListSpacesForAuthenticatedUser200Response(items []Space) *ListSpacesForAuthenticatedUser200Response {
	this := ListSpacesForAuthenticatedUser200Response{}
	this.Items = items
	return &this
}
...
func (o ListSpacesForAuthenticatedUser200Response) MarshalJSON() ([]byte, error) {
...
type NullableListSpacesForAuthenticatedUser200Response struct {
	value *ListSpacesForAuthenticatedUser200Response
	isSet bool
}

func (v NullableListSpacesForAuthenticatedUser200Response) Get() *ListSpacesForAuthenticatedUser200Response {
	return v.value
}

func (v *NullableListSpacesForAuthenticatedUser200Response) Set(val *ListSpacesForAuthenticatedUser200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSpacesForAuthenticatedUser200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSpacesForAuthenticatedUser200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSpacesForAuthenticatedUser200Response(val *ListSpacesForAuthenticatedUser200Response) *NullableListSpacesForAuthenticatedUser200Response {
	return &NullableListSpacesForAuthenticatedUser200Response{value: val, isSet: true}
}

func (v NullableListSpacesForAuthenticatedUser200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListSpacesForAuthenticatedUser200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
