...
// checks if the BillingUpgradeOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingUpgradeOneOf2{}
...
type NullableBillingUpgradeOneOf2 struct {
	value *BillingUpgradeOneOf2
	isSet bool
}

func (v NullableBillingUpgradeOneOf2) Get() *BillingUpgradeOneOf2 {
	return v.value
}

func (v *NullableBillingUpgradeOneOf2) Set(val *BillingUpgradeOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingUpgradeOneOf2) IsSet() bool {
	return v.isSet
}
...
func NewNullableBillingUpgradeOneOf2(val *BillingUpgradeOneOf2) *NullableBillingUpgradeOneOf2 {
	return &NullableBillingUpgradeOneOf2{value: val, isSet: true}
}
