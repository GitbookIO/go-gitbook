...
// checks if the ListChangeRequestsForSpace200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListChangeRequestsForSpace200Response{}
...
func NewListChangeRequestsForSpace200Response(items []ChangeRequest) *ListChangeRequestsForSpace200Response {
	this := ListChangeRequestsForSpace200Response{}
	this.Items = items
	return &this
}
...
type NullableListChangeRequestsForSpace200Response struct {
	value *ListChangeRequestsForSpace200Response
	isSet bool
}

func (v NullableListChangeRequestsForSpace200Response) Get() *ListChangeRequestsForSpace200Response {
	return v.value
}

func (v *NullableListChangeRequestsForSpace200Response) Set(val *ListChangeRequestsForSpace200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListChangeRequestsForSpace200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListChangeRequestsForSpace200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListChangeRequestsForSpace200Response(val *ListChangeRequestsForSpace200Response) *NullableListChangeRequestsForSpace200Response {
	return &NullableListChangeRequestsForSpace200Response{value: val, isSet: true}
}

func (v NullableListChangeRequestsForSpace200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListChangeRequestsForSpace200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
