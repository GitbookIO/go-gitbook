...
// checks if the ListOrganizationsForAuthenticatedUser200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListOrganizationsForAuthenticatedUser200Response{}
...
func NewListOrganizationsForAuthenticatedUser200Response(items []Organization) *ListOrganizationsForAuthenticatedUser200Response {
	this := ListOrganizationsForAuthenticatedUser200Response{}
	this.Items = items
	return &this
}
...
func (o ListOrganizationsForAuthenticatedUser200Response) MarshalJSON() ([]byte, error) {
...
type NullableListOrganizationsForAuthenticatedUser200Response struct {
	value *ListOrganizationsForAuthenticatedUser200Response
	isSet bool
}

func (v NullableListOrganizationsForAuthenticatedUser200Response) Get() *ListOrganizationsForAuthenticatedUser200Response {
	return v.value
}

func (v *NullableListOrganizationsForAuthenticatedUser200Response) Set(val *ListOrganizationsForAuthenticatedUser200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListOrganizationsForAuthenticatedUser200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListOrganizationsForAuthenticatedUser200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListOrganizationsForAuthenticatedUser200Response(val *ListOrganizationsForAuthenticatedUser200Response) *NullableListOrganizationsForAuthenticatedUser200Response {
	return &NullableListOrganizationsForAuthenticatedUser200Response{value: val, isSet: true}
}

func (v NullableListOrganizationsForAuthenticatedUser200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListOrganizationsForAuthenticatedUser200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
