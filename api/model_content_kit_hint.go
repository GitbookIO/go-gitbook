...
// checks if the ContentKitHint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentKitHint{}
...
type NullableContentKitHint struct {
	value *ContentKitHint
	isSet bool
}

func (v NullableContentKitHint) Get() *ContentKitHint {
	return v.value
}

func (v *NullableContentKitHint) Set(val *ContentKitHint) {
	v.value = val
	v.isSet = true
}
...
func NewNullableContentKitHint(val *ContentKitHint) *NullableContentKitHint {
	return &NullableContentKitHint{value: val, isSet: true}
}
