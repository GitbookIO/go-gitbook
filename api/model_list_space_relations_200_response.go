...
// checks if the ListSpaceRelations200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListSpaceRelations200Response{}
...
func NewListSpaceRelations200Response(items []SpaceRelation) *ListSpaceRelations200Response {
	this := ListSpaceRelations200Response{}
	this.Items = items
	return &this
}
...
type NullableListSpaceRelations200Response struct {
	value *ListSpaceRelations200Response
	isSet bool
}

func (v NullableListSpaceRelations200Response) Get() *ListSpaceRelations200Response {
	return v.value
}

func (v *NullableListSpaceRelations200Response) Set(val *ListSpaceRelations200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListSpaceRelations200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListSpaceRelations200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListSpaceRelations200Response(val *ListSpaceRelations200Response) *NullableListSpaceRelations200Response {
	return &NullableListSpaceRelations200Response{value: val, isSet: true}
}
