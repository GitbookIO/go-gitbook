...
// checks if the GetContributorsByChangeRequestId200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetContributorsByChangeRequestId200Response{}
...
func NewGetContributorsByChangeRequestId200Response(items []UserContributor) *GetContributorsByChangeRequestId200Response {
	this := GetContributorsByChangeRequestId200Response{}
	this.Items = items
	return &this
}
...
func (o GetContributorsByChangeRequestId200Response) MarshalJSON() ([]byte, error) {
...
type NullableGetContributorsByChangeRequestId200Response struct {
	value *GetContributorsByChangeRequestId200Response
	isSet bool
}

func (v NullableGetContributorsByChangeRequestId200Response) Get() *GetContributorsByChangeRequestId200Response {
	return v.value
}

func (v *NullableGetContributorsByChangeRequestId200Response) Set(val *GetContributorsByChangeRequestId200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetContributorsByChangeRequestId200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetContributorsByChangeRequestId200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetContributorsByChangeRequestId200Response(val *GetContributorsByChangeRequestId200Response) *NullableGetContributorsByChangeRequestId200Response {
	return &NullableGetContributorsByChangeRequestId200Response{value: val, isSet: true}
}

func (v NullableGetContributorsByChangeRequestId200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetContributorsByChangeRequestId200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
