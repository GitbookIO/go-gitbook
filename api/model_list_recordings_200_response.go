...
// checks if the ListRecordings200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListRecordings200Response{}
...
func NewListRecordings200Response(items []Recording) *ListRecordings200Response {
	this := ListRecordings200Response{}
	this.Items = items
	return &this
}
...
type NullableListRecordings200Response struct {
	value *ListRecordings200Response
	isSet bool
}

func (v NullableListRecordings200Response) Get() *ListRecordings200Response {
	return v.value
}

func (v *NullableListRecordings200Response) Set(val *ListRecordings200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListRecordings200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListRecordings200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListRecordings200Response(val *ListRecordings200Response) *NullableListRecordings200Response {
	return &NullableListRecordings200Response{value: val, isSet: true}
}
